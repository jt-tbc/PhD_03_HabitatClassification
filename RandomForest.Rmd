...
setwd("C:/OneDrive/C3_Map/RF_Outputs/Figures")
set.seed(415)

L1_Hab.randomForest <- randomForest(as.factor(L1_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/ALL_L1_Hab.txt")
L1_Hab.randomForest 
sink()
...
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
...
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
...
setwd("C:/OneDrive/C3_Map/RF_Outputs/Lv1Outputs")
...
HB_L1_Hab.randomForest <- randomForest(as.factor(L1_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= HBmodel, 
...
print(importance(HB_L1_Hab.randomForest,type = 2))
plot(HB_L1_Hab.randomForest)
importance(HB_L1_Hab.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/HB_L1_Hab.txt")
...
TB_L1_Hab.randomForest <- randomForest(as.factor(L1_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= TBmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/TB_L1_Hab.txt")
...
MG_L1_Hab.randomForest <- randomForest(as.factor(L1_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= MGmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/MG_L1_Hab.txt")
...
SS_L1_Hab.randomForest <- randomForest(as.factor(L1_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= SSmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/SS_L1_Hab.txt")
...
SS_L1_HabPredImport <- as.data.frame(sort(importance(SS_L1_Hab.randomForest)[,4], decreasing = TRUE))
names(SS_L1_HabPredImport) <- c("MeanDecreaseGini")
write.table(SS_L1_HabPredImport, file = "SS_L1_Hab_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))
...
L2_Hab.randomForest <- randomForest(as.factor(L2_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= model, 
...
print(L2_Hab.randomForest)
print(importance(L2_Hab.randomForest,type = 2))
plot(L2_Hab.randomForest)
importance(L2_Hab.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/ALL_L2_Hab.txt")
L2_Hab.randomForest 
sink()


png(file = 'All_L2_Hab_VarImpPlot.png', width = 8, height = 8, units = 'in', res = 300)
varImpPlot(L2_Hab.randomForest,
           sort = T,
           main="Variable Importance")
dev.off()

L2_HabPredImport <- as.data.frame(sort(importance(L2_Hab.randomForest)[,4], decreasing = TRUE))
names(L2_HabPredImport) <- c("MeanDecreaseGini")
write.table(L2_HabPredImport, file = "All_L2_Hab_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))

true.type = as.factor(test[,14])
predicted = predict(L2_Hab.randomForest, test,type="class")
table(true.type,predicted)
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
write.csv(table(true.type,predicted), "2_RF_Lv2_MisclassMatrix.csv") # need to rename this file

# need to edit, look at http://trevorstephens.com/kaggle-titanic-tutorial/r-part-5-random-forests/
PredictionL2_Hab <- predict(L2_Hab.randomForest, test)
submitL2_Hab <- data.frame(HabType = test$L2_Hab, PredictedL2_Hab = PredictionL2_Hab, X = test$Lat, Y = test$Long)
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
write.csv(submitL2_Hab, file = "L2_Habrandomforest.csv", row.names = FALSE)
...
L2_Hab.rF.predict <- predict(L2_Hab.randomForest, points1)
L2_Hab.predict <- as.data.frame(L2_Hab.rF.predict)
pred.L2_Hab <- as.data.frame(cbind(points1$Long, points1$Lat, L2_Hab.predict))
pred.L2_Hab$L2_Hab.rF.predict <- as.numeric(as.character(pred.L2_Hab$L2_Hab.rF.predict))
names(pred.L2_Hab) <- c("X","Y", "predL2_Hab")


L2_Hab.rF.predict2 <- predict(L2_Hab.randomForest, points2)
L2_Hab.predict2 <- as.data.frame(L2_Hab.rF.predict2)
pred.L2_Hab2 <- as.data.frame(cbind(points2$Long, points2$Lat,  L2_Hab.predict2))
pred.L2_Hab2$L2_Hab.rF.predict2 <- as.numeric(as.character(pred.L2_Hab2$L2_Hab.rF.predict2))
names(pred.L2_Hab2) <- c("X","Y", "predL2_Hab")

L2_Hab.rF.predict3 <- predict(L2_Hab.randomForest, points3)
L2_Hab.predict3 <- as.data.frame(L2_Hab.rF.predict3)
pred.L2_Hab3 <- as.data.frame(cbind(points3$Long, points3$Lat,  L2_Hab.predict3))
pred.L2_Hab3$L2_Hab.rF.predict3 <- as.numeric(as.character(pred.L2_Hab3$L2_Hab.rF.predict3))
...
HB_L2_Hab.randomForest <- randomForest(as.factor(L2_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= HBmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/HB_L2_Hab.txt")
...
TB_L2_Hab.randomForest <- randomForest(as.factor(L2_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= TBmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/TB_L2_Hab.txt")
...
MG_L2_Hab.randomForest <- randomForest(as.factor(L2_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= MGmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/MG_L2_Hab.txt")
...
SS_L2_Hab.randomForest <- randomForest(as.factor(L2_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= SSmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/SS_L2_Hab.txt")
...
L3_Hab.randomForest <- randomForest(as.factor(L3_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= model, 
...
print(L3_Hab.randomForest)
print(importance(L3_Hab.randomForest,type = 2))
plot(L3_Hab.randomForest)
importance(L3_Hab.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/ALL_L3_Hab.txt")
L3_Hab.randomForest 
sink()


png(file = 'All_L3_Hab_VarImpPlot.png', width = 8, height = 8, units = 'in', res = 300)
varImpPlot(L3_Hab.randomForest,
           sort = T,
           main="Variable Importance")
dev.off()

L3_HabPredImport <- as.data.frame(sort(importance(L3_Hab.randomForest)[,4], decreasing = TRUE))
names(L3_HabPredImport) <- c("MeanDecreaseGini")
write.table(L3_HabPredImport, file = "All_L3_Hab_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))

true.type = as.factor(test[,15])
predicted = predict(L3_Hab.randomForest, test,type="class")
table(true.type,predicted)
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
write.csv(table(true.type,predicted), "3_RF_Lv3_MisclassMatrix.csv") # need to rename this file

# need to edit, look at http://trevorstephens.com/kaggle-titanic-tutorial/r-part-5-random-forests/
PredictionL3_Hab <- predict(L3_Hab.randomForest, test)
submitL3_Hab <- data.frame(HabType = test$L3_Hab, PredictedL3_Hab = PredictionL3_Hab, X = test$Lat, Y = test$Long)
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
write.csv(submitL3_Hab, file = "L3_Habrandomforest.csv", row.names = FALSE)
...
L3_Hab.rF.predict <- predict(L3_Hab.randomForest, points1)
L3_Hab.predict <- as.data.frame(L3_Hab.rF.predict)
pred.L3_Hab <- as.data.frame(cbind(points1$Long, points1$Lat, L3_Hab.predict))
pred.L3_Hab$L3_Hab.rF.predict <- as.numeric(as.character(pred.L3_Hab$L3_Hab.rF.predict))
names(pred.L3_Hab) <- c("X","Y", "predL3_Hab")


L3_Hab.rF.predict2 <- predict(L3_Hab.randomForest, points2)
L3_Hab.predict2 <- as.data.frame(L3_Hab.rF.predict2)
pred.L3_Hab2 <- as.data.frame(cbind(points2$Long, points2$Lat,  L3_Hab.predict2))
pred.L3_Hab2$L3_Hab.rF.predict2 <- as.numeric(as.character(pred.L3_Hab2$L3_Hab.rF.predict2))
names(pred.L3_Hab2) <- c("X","Y", "predL3_Hab")

L3_Hab.rF.predict3 <- predict(L3_Hab.randomForest, points3)
L3_Hab.predict3 <- as.data.frame(L3_Hab.rF.predict3)
pred.L3_Hab3 <- as.data.frame(cbind(points3$Long, points3$Lat,  L3_Hab.predict3))
pred.L3_Hab3$L3_Hab.rF.predict3 <- as.numeric(as.character(pred.L3_Hab3$L3_Hab.rF.predict3))
...
HB_L3_Hab.randomForest <- randomForest(as.factor(L3_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= HBmodel, 
...
print(HB_L3_Hab.randomForest)
print(importance(HB_L3_Hab.randomForest,type = 2))
plot(HB_L3_Hab.randomForest)
importance(HB_L3_Hab.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/HB_L3_Hab.txt")
HB_L3_Hab.randomForest 
sink()

setwd("C:/OneDrive/C3_Map/RF_Outputs/Figures")
png(file = 'HB_L3_Hab_VarImpPlot.png', width = 8, height = 8, units = 'in', res = 300)
varImpPlot(HB_L3_Hab.randomForest,
           sort = T,
           main="Variable Importance")
dev.off()

HB_L3_HabPredImport <- as.data.frame(sort(importance(HB_L3_Hab.randomForest)[,4], decreasing = TRUE))
names(HB_L3_HabPredImport) <- c("MeanDecreaseGini")
write.table(HB_L3_HabPredImport, file = "HB_L3_Hab_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))

true.type = as.factor(HBtest[,15])
predicted = predict(HB_L3_Hab.randomForest, HBtest,type="class")
table(true.type,predicted)
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
write.csv(table(true.type,predicted), "12_RF_HB_Lv3_MisclassMatrix.csv")

# need to edit, look at http://trevorstephens.com/kaggle-titanic-tutorial/r-part-5-random-forests/
PredictionHB_L3_Hab <- predict(HB_L3_Hab.randomForest, HBtest)
submitHB_L3_Hab <- data.frame(HabType = HBtest$L3_Hab, PredictedL3_Hab = PredictionHB_L3_Hab, X = HBtest$Lat, Y = HBtest$Long)
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
write.csv(submitHB_L3_Hab, file = "HB_L3_Habrandomforest.csv", row.names = FALSE)
...
HB_L3_Hab.rF.predict <- predict(HB_L3_Hab.randomForest, HBpoints)
HB_L3_Hab.predict <- as.data.frame(HB_L3_Hab.rF.predict)
pred.HB_L3_Hab <- as.data.frame(cbind(HBpoints$Long, HBpoints$Lat, HB_L3_Hab.predict))
pred.HB_L3_Hab$HB_L3_Hab.rF.predict <- as.numeric(as.character(pred.HB_L3_Hab$HB_L3_Hab.rF.predict))
...
writeRaster(to_asciiHB,'HB_L3_HabRF.asc', format='ascii', overwrite =TRUE)
...
TB_L3_Hab.randomForest <- randomForest(as.factor(L3_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= TBmodel, 
...
print(TB_L3_Hab.randomForest)
print(importance(TB_L3_Hab.randomForest,type = 2))
plot(TB_L3_Hab.randomForest)
importance(TB_L3_Hab.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/TB_L3_Hab.txt")
TB_L3_Hab.randomForest 
sink()

setwd("C:/OneDrive/C3_Map/RF_Outputs/Figures")
png(file = 'TB_L3_Hab_VarImpPlot.png', width = 8, height = 8, units = 'in', res = 300)
varImpPlot(TB_L3_Hab.randomForest,
           sort = T,
           main="Variable Importance")
dev.off()

TB_L3_HabPredImport <- as.data.frame(sort(importance(TB_L3_Hab.randomForest)[,4], decreasing = TRUE))
names(TB_L3_HabPredImport) <- c("MeanDecreaseGini")
write.table(TB_L3_HabPredImport, file = "TB_L3_Hab_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))

true.type = as.factor(TBtest[,15])
predicted = predict(TB_L3_Hab.randomForest, TBtest,type="class")
table(true.type,predicted)
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
write.csv(table(true.type,predicted), "13_RF_TB_Lv3_MisclassMatrix.csv")

# need to edit, look at http://trevorstephens.com/kaggle-titanic-tutorial/r-part-5-random-forests/
PredictionTB_L3_Hab <- predict(TB_L3_Hab.randomForest, TBtest)
submitTB_L3_Hab <- data.frame(HabType = TBtest$L3_Hab, PredictedL3_Hab = PredictionTB_L3_Hab, X = TBtest$Lat, Y = TBtest$Long)
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
write.csv(submitTB_L3_Hab, file = "TB_L3_Habrandomforest.csv", row.names = FALSE)
...
TB_L3_Hab.rF.predict <- predict(TB_L3_Hab.randomForest, TBpoints)
TB_L3_Hab.predict <- as.data.frame(TB_L3_Hab.rF.predict)
pred.TB_L3_Hab <- as.data.frame(cbind(TBpoints$Long, TBpoints$Lat, TB_L3_Hab.predict))
pred.TB_L3_Hab$TB_L3_Hab.rF.predict <- as.numeric(as.character(pred.TB_L3_Hab$TB_L3_Hab.rF.predict))
...
writeRaster(to_asciiTB,'TB_L3_HabRF.asc', format='ascii', overwrite =TRUE)
...
MG_L3_Hab.randomForest <- randomForest(as.factor(L3_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= MGmodel, 
...
print(MG_L3_Hab.randomForest)
print(importance(MG_L3_Hab.randomForest,type = 2))
plot(MG_L3_Hab.randomForest)
importance(MG_L3_Hab.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/MG_L3_Hab.txt")
MG_L3_Hab.randomForest 
sink()

setwd("C:/OneDrive/C3_Map/RF_Outputs/Figures")
png(file = 'MG_L3_Hab_VarImpPlot.png', width = 8, height = 8, units = 'in', res = 300)
varImpPlot(MG_L3_Hab.randomForest,
           sort = T,
           main="Variable Importance")
dev.off()

MG_L3_HabPredImport <- as.data.frame(sort(importance(MG_L3_Hab.randomForest)[,4], decreasing = TRUE))
names(MG_L3_HabPredImport) <- c("MeanDecreaseGini")
write.table(MG_L3_HabPredImport, file = "MG_L3_Hab_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))

true.type = as.factor(MGtest[,15])
predicted = predict(MG_L3_Hab.randomForest, MGtest,type="class")
table(true.type,predicted)
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
write.csv(table(true.type,predicted), "14_RF_MG_Lv3_MisclassMatrix.csv")

# need to edit, look at http://trevorstephens.com/kaggle-titanic-tutorial/r-part-5-random-forests/
PredictionMG_L3_Hab <- predict(MG_L3_Hab.randomForest, MGtest)
submitMG_L3_Hab <- data.frame(HabType = MGtest$L3_Hab, PredictedL3_Hab = PredictionMG_L3_Hab, X = MGtest$Lat, Y = MGtest$Long)
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
write.csv(submitMG_L3_Hab, file = "MG_L3_Habrandomforest.csv", row.names = FALSE)
...
MG_L3_Hab.rF.predict <- predict(MG_L3_Hab.randomForest, MGpoints)
MG_L3_Hab.predict <- as.data.frame(MG_L3_Hab.rF.predict)
pred.MG_L3_Hab <- as.data.frame(cbind(MGpoints$Long, MGpoints$Lat, MG_L3_Hab.predict))
pred.MG_L3_Hab$MG_L3_Hab.rF.predict <- as.numeric(as.character(pred.MG_L3_Hab$MG_L3_Hab.rF.predict))
...
writeRaster(to_asciiMG,'MG_L3_HabRF.asc', format='ascii', overwrite =TRUE)
...
SS_L3_Hab.randomForest <- randomForest(as.factor(L3_Hab) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= SSmodel, 
...
print(SS_L3_Hab.randomForest)
print(importance(SS_L3_Hab.randomForest,type = 2))
plot(SS_L3_Hab.randomForest)
importance(SS_L3_Hab.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/SS_L3_Hab.txt")
SS_L3_Hab.randomForest 
sink()

setwd("C:/OneDrive/C3_Map/RF_Outputs/Figures")
png(file = 'SS_L3_Hab_VarImpPlot.png', width = 8, height = 8, units = 'in', res = 300)
varImpPlot(SS_L3_Hab.randomForest,
           sort = T,
           main="Variable Importance")
dev.off()

SS_L3_HabPredImport <- as.data.frame(sort(importance(SS_L3_Hab.randomForest)[,4], decreasing = TRUE))
names(SS_L3_HabPredImport) <- c("MeanDecreaseGini")
write.table(SS_L3_HabPredImport, file = "SS_L3_Hab_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))

true.type = as.factor(SStest[,15])
predicted = predict(SS_L3_Hab.randomForest, SStest,type="class")
table(true.type,predicted)
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
write.csv(table(true.type,predicted), "15_RF_SS_Lv3_MisclassMatrix.csv")

# need to edit, look at http://trevorstephens.com/kaggle-titanic-tutorial/r-part-5-random-forests/
PredictionSS_L3_Hab <- predict(SS_L3_Hab.randomForest, SStest)
submitSS_L3_Hab <- data.frame(HabType = SStest$L3_Hab, PredictedL3_Hab = PredictionSS_L3_Hab, X = SStest$Lat, Y = SStest$Long)
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
write.csv(submitSS_L3_Hab, file = "SS_L3_Habrandomforest.csv", row.names = FALSE)
...
SS_L3_Hab.rF.predict <- predict(SS_L3_Hab.randomForest, SSpoints)
SS_L3_Hab.predict <- as.data.frame(SS_L3_Hab.rF.predict)
pred.SS_L3_Hab <- as.data.frame(cbind(SSpoints$Long, SSpoints$Lat, SS_L3_Hab.predict))
pred.SS_L3_Hab$SS_L3_Hab.rF.predict <- as.numeric(as.character(pred.SS_L3_Hab$SS_L3_Hab.rF.predict))
...
writeRaster(to_asciiSS,'SS_L3_HabRF.asc', format='ascii', overwrite =TRUE)
...
L3_Hab_EDIT.randomForest <- randomForest(as.factor(L3_Hab_EDIT) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	
                                           mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
...
print(L3_Hab_EDIT.randomForest)
print(importance(L3_Hab_EDIT.randomForest,type = 2))
plot(L3_Hab_EDIT.randomForest)
importance(L3_Hab_EDIT.randomForest)

sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/ALL_L3_Hab_EDIT.txt")
L3_Hab_EDIT.randomForest 
sink()


png(file = 'All_L3_Hab_EDIT_VarImpPlot.png', width = 8, height = 8, units = 'in', res = 300)
varImpPlot(L3_Hab_EDIT.randomForest,
           sort = T,
           main="Variable Importance")
dev.off()

L3_Hab_EDITPredImport <- as.data.frame(sort(importance(L3_Hab_EDIT.randomForest)[,4], decreasing = TRUE))
names(L3_Hab_EDITPredImport) <- c("MeanDecreaseGini")
write.table(L3_Hab_EDITPredImport, file = "All_L3_Hab_EDIT_predictor_importance.txt",
            append = FALSE, sep = "\t", eol = "\n", na = "NA", dec = ".", row.names = TRUE,
            col.names = TRUE, qmethod = c("escape", "double"))

true.type = as.factor(test[,16])
predicted = predict(L3_Hab_EDIT.randomForest, test,type="class")
table(true.type,predicted)
setwd("C:/OneDrive/C3_Map/RF_Outputs/BER")
write.csv(table(true.type,predicted), "16_RF_Lv3_EDIT_MisclassMatrix.csv") # need to rename this file

# need to edit, look at http://trevorstephens.com/kaggle-titanic-tutorial/r-part-5-random-forests/
PredictionL3_Hab_EDIT <- predict(L3_Hab_EDIT.randomForest, test)
submitL3_Hab_EDIT <- data.frame(HabType = test$L3_Hab_EDIT, PredictedL3_Hab_EDIT = PredictionL3_Hab_EDIT, X = test$Lat, Y = test$Long)
setwd("C:/OneDrive/C3_Map/RF_Outputs/ROCtests")
write.csv(submitL3_Hab_EDIT, file = "L3_Hab_EDITrandomforest.csv", row.names = FALSE)
...
L3_Hab_EDIT.rF.predict <- predict(L3_Hab_EDIT.randomForest, points1)
L3_Hab_EDIT.predict <- as.data.frame(L3_Hab_EDIT.rF.predict)
pred.L3_Hab_EDIT <- as.data.frame(cbind(points1$Long, points1$Lat, L3_Hab_EDIT.predict))
pred.L3_Hab_EDIT$L3_Hab_EDIT.rF.predict <- as.numeric(as.character(pred.L3_Hab_EDIT$L3_Hab_EDIT.rF.predict))
names(pred.L3_Hab_EDIT) <- c("X","Y", "predL3_Hab_EDIT")


L3_Hab_EDIT.rF.predict2 <- predict(L3_Hab_EDIT.randomForest, points2)
L3_Hab_EDIT.predict2 <- as.data.frame(L3_Hab_EDIT.rF.predict2)
pred.L3_Hab_EDIT2 <- as.data.frame(cbind(points2$Long, points2$Lat,  L3_Hab_EDIT.predict2))
pred.L3_Hab_EDIT2$L3_Hab_EDIT.rF.predict2 <- as.numeric(as.character(pred.L3_Hab_EDIT2$L3_Hab_EDIT.rF.predict2))
names(pred.L3_Hab_EDIT2) <- c("X","Y", "predL3_Hab_EDIT")

L3_Hab_EDIT.rF.predict3 <- predict(L3_Hab_EDIT.randomForest, points3)
L3_Hab_EDIT.predict3 <- as.data.frame(L3_Hab_EDIT.rF.predict3)
pred.L3_Hab_EDIT3 <- as.data.frame(cbind(points3$Long, points3$Lat,  L3_Hab_EDIT.predict3))
pred.L3_Hab_EDIT3$L3_Hab_EDIT.rF.predict3 <- as.numeric(as.character(pred.L3_Hab_EDIT3$L3_Hab_EDIT.rF.predict3))
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/HB_L3_Hab_EDIT.txt")
...
TB_L3_Hab_EDIT.randomForest <- randomForest(as.factor(L3_Hab_EDIT) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= TBmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/TB_L3_Hab_EDIT.txt")
...
MG_L3_Hab_EDIT.randomForest <- randomForest(as.factor(L3_Hab_EDIT) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= MGmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/MG_L3_Hab_EDIT.txt")
...
SS_L3_Hab_EDIT.randomForest <- randomForest(as.factor(L3_Hab_EDIT) ~ curv +	curv_plan +	curv_prof +	slope +	mean3 +	mean5 +	mean10 +
                       mean25 +	std3 +	std5 +	std10 +	std25 +	range3 +	range5 +	range10 +	range25 +
                       hyp3 +	hyp5 +	hyp10 +	hyp25 +	rugosity +	east +	north +	BPI_F_10 +	BPI_F_15 +
                       BPI_F_25 +	BPI_B_50 +	BPI_B_100 +	BPI_B_250 +	Depth + BScatter,
                     data= SSmodel, 
...
sink("C:/OneDrive/C3_Map/RF_Outputs/Figures/SS_L3_Hab_EDIT.txt")
